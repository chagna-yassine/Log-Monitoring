"""
Generate a comprehensive Jupyter notebook for fine-tuning Qwen2.5-72B-Instruct
with SoftMoE and quantization for log understanding tasks.
"""
...
def create_notebook():
    ...
    cells = [
        # Cell 1: Title and Introduction
        {
            ...
            "source": [
                ...
                "- ⚡ **4-bit Quantization** (QLoRA) for efficient training on large models\n",
                "- 🧠 **Soft Mixture of Experts (SoftMoE)** for specialized log understanding\n",
        ...
        # Cell 6: HuggingFace Authentication
        {
            ...
            "source": [
                ...
                "        print(\"✅ Logged in to HuggingFace using Colab secrets\")\n",
                "    except:\n",
        ...
        # Cell 8: SoftMoE Code
        {
            ...
            "source": [
                ...
                "        return output\n",
                "\n",
                "print(\"✅ SoftMoE implementation loaded\")"
            ]
        },
    ...
    # Add more cells for the rest of the notebook
    cells.extend([
        # Multi-task generator section
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": [
    ...
    # Add the rest of the training cells (continuing from where we left off...)
    remaining_cells = [
        # Load Model Section
        {
            "cell_type": "markdown",
        ...
        
        {
            ...
            "source": [
                ...
                "print(\"\\n⚠️  Training may take several hours depending on your GPU...\\n\")\n",
                "\n",
                "# Train\n",
        ...
        
        {
            ...
            "source": [
                ...
                "print(\"=\"*80)\n",
                "print(f\"\\n✅ Successfully fine-tuned {config.model_name}\")\n",
                "print(f\"\\n📊 Training Statistics:\")\n",
                ...
                "\n",
                "print(f\"\\n🎯 Capabilities:\")\n",
                "print(\"  ✅ Log Parsing - Extract templates from raw logs\")\n",
                "print(\"  ✅ Log Classification - Detect anomalies\")\n",
                "print(\"  ✅ Log Summarization - Summarize log sequences\")\n",
                "\n",
                "print(f\"\\n🚀 Next Steps:\")\n",
                ...
                "\n",
                "if IN_COLAB:\n",
                "    print(f\"\\n💡 Tip: Download the model from {config.output_dir} or save to Google Drive\")\n",
                "\n",
                "print(\"\\n\" + \"=\"*80)"
            ]
        },
...
if __name__ == "__main__":
    print("Generating Qwen fine-tuning notebook...")
    notebook = create_notebook()
    
    output_path = "finetune_qwen_softmoe_logs.ipynb"
    with open(output_path, 'w', encoding='utf-8') as f:
        json.dump(notebook, f, indent=1, ensure_ascii=False)
    
    print(f"[SUCCESS] Notebook created: {output_path}")
