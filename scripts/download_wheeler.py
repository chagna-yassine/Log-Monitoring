"""
Download Wheeler AIT dataset from Zenodo
"""
...
def main():
    """Download Wheeler AIT dataset."""
    print("="*70)
    print("DOWNLOAD WHEELER AIT DATASET")
    print("="*70)
    ...
    if download_file(url, archive_path):
        ...
        if extract_zip(archive_path, extract_path):
            ...
            print(f"\nNow run:")
            print(f"  python scripts/upload_wheeler_logs.py")
        else:
