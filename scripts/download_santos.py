"""
Download Santos AIT dataset from Zenodo
"""
...
def main():
    """Download Santos AIT dataset."""
    print("="*70)
    print("DOWNLOAD SANTOS AIT DATASET")
    print("="*70)
    ...
    if download_file(url, archive_path):
        ...
        if extract_zip(archive_path, extract_path):
            ...
            print(f"\nNow run:")
            print(f"  python scripts/upload_santos_logs.py")
        else:
